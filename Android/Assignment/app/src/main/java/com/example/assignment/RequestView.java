...
public class RequestView extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Request_information=findViewById(R.id.reqcondition);

        Bundle requestBundle=getIntent().getBundleExtra("req_model");

        String Requestdata= requestBundle != null ? requestBundle.getString("RequestInfor") : null;
        Request_information.setText(Requestdata);
        String Requeststat= requestBundle != null ? requestBundle.getString("RequestStatus") : null;
